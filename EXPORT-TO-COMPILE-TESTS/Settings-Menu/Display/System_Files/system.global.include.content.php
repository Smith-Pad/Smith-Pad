...
function content() {
        ...
        print('<center><FOIL-font-size-40> Display Settings </FOIL-font-size-40></center>');


        // After the user presses this button, it will allow the user to adjust the display brightness.

...
<div class="bar">
  <a href="./3.php" class="button small button is-red button-no-animate-mode">Back &#8656;</a>
  <a href="./index.php" class="button small button is-red button-no-animate-mode">Home &#9750;</a>
  <a href="./5.php" class="button small button is-red button-no-animate-mode">Next &rArr;</a>
...
<div class="indicator is-off button-no-animate-mode">
  ...
  <h1 align="center">
    <boxer>
      <fontcolorRED>x</fontcolorRED> - 4 = -4
    </boxer>
  </h1>
  <h3 align="center"> Put a Minus 4 on Top of + 4, </h3>
  <h3 align="center">Then put a - 4 on top of 8 </h3>
  <ul></ul>
  <div class="space"></div>
  <div class="space"></div>
  <div class="space"></div>
  ...
  <center><a href="5.php" class="button">What's the next step ? </a>

    <a href="3.php" class="button">Go back to Previous Step </a></center>

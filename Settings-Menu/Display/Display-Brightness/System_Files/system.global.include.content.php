...
function content() {
        ...
        print('<center><a href="../low.php" class="FOIL-button-regular-no-shadow color-is-red">LOW</a></center>');
        print('<center><a href="../high.php" class="FOIL-button-regular-no-shadow color-is-green">HIGH</a></center>');
}
content();
?>
